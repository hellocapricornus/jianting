...
# 关键词
FILTER_KEYWORDS = ["精聊", "刷单", "大区", "泰铢", "仲裁", "卡主姓名", "入金金额", "股票", "换汇", "公检法", "盘", "通道", "源头", "进算", "拖算", "滲透", "哈萨克", "无视", "尼日", "料"]
...
BLOCK_KEYWORDS = ["京东", "淘宝", "天猫", "拼多多", "支付宝", "微信", "Q币", "苏宁", "粉", "能量", "数据", "反扫", "内转港", "跨境", "常规",
                  ...
                  "红包", "广告", "约", "交友", "信用", "会员", "日进", "口嗨", "短信", "正品", "低价", "码车", "卡车", "卡卡", "u", "U",
                  "直招", "上班", "新闻", "短视频", "进入", "直招", "安全","电子", "电子", "AG", "ag", "小白", "优惠", "真人", "茶",
                  "农商", "白名单", "奢侈品", "珠宝", "时代", "红红", "海外粉", "一手", "168", "138", "营业", "宵夜"]
