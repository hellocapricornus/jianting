...
# 关键词
FILTER_KEYWORDS = ["精聊", "刷单", "大区", "股票", "换汇", "公检法", "盘", "通道", "源头", "进算", "拖算", "滲透", "哈萨克", "无视", "尼日", "料", "课", "夜"]
...
# 新增：屏蔽词
BLOCK_KEYWORDS = ["京东", "淘宝", "天猫", "拼多多", "支付宝", "微信", "Q币", "苏宁", "bc", "贷", "司法", "码", "油卡", "实体卡", "联系我", "NFC", "快手", "抖音", "抖币", "油", "散户", "境外", "礼品卡", "核销", "ATM", "取现", "柜台", "实物", "闲鱼", "U", "u", "BC", "料性", "空降", "色", "教程", "风险", "汇率","国内","手机","滴滴","宵夜"]
