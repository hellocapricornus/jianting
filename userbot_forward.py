...
# 关键词
FILTER_KEYWORDS = ["精聊", "刷单", "大区", "卡主姓名", "入金金额", "股票", "今日小记", "换汇", "公检法", "盘", "通道", "源头", "进算", "拖算", "滲透", "哈萨克", "无视", "尼日", "料"]
...
# 新增：屏蔽词
BLOCK_KEYWORDS = ["京东", "淘宝", "天猫", "拼多多", "支付宝", "微信", "Q币", "苏宁", "粉", "能量", "数据", "反扫", "内转港", "跨境", "常规", "全国", "飞机", "键盘", "搞", "资料", "SPA", "慈善", "活跃",
                  "bc", "贷", "司法", "码", "油卡", "实体卡", "联系我", "NFC", "快手", "抖音", "抖币", "油", "华夏", "工商", "农行", "福利", "定制", "话术", "门路", "有效", "园区", "年龄", "拉群",
                  "散户", "境外", "礼品卡", "核销", "ATM", "取现", "柜台", "实物", "闲鱼", "BC", "聚合", "赚钱", "口令", "荷包","团队","个人","招人","机会", "赚米", "风口", "包养", "时时彩",
                   "空降", "色", "教程", "风险", "汇率", "国内", "手机", "滴滴", "香水", "伟哥", "机房", "癌", "红包", "广告", "约", "交友", "信用", "会员", "日进", "口嗨", "短信", "正品", "低价",
                  "直招", "上班", "新闻", "短视频", "进入", "直招", "安全","电子", "电子", "AG", "ag", "小白", "优惠", "真人", "茶", "宵夜"]
