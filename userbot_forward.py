...
# 新增：屏蔽词
BLOCK_KEYWORDS = ["京东", "淘宝", "天猫", "拼多多", "支付宝", "微信", "Q币", "苏宁", "粉", "能量", "数据", "反扫", "内转港", "跨境","常规","全国","号","飞机",
                  "bc", "贷", "司法", "码", "油卡", "实体卡", "联系我", "NFC", "快手", "抖音", "抖币", "油", "华夏", "工商", "农行", "福利", "定制","银行",
                  "散户", "境外", "礼品卡", "核销", "ATM", "取现", "柜台", "实物", "闲鱼", "U", "u", "BC", "聚合", "赚钱", "口令", "荷包",
                  "料性", "空降", "色", "教程", "风险", "汇率","国内","手机","滴滴","香水","伟哥","机房","癌","红包","广告","约","交友","信用","会员","宵夜"]
